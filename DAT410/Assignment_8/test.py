...
JINA_API_KEY = "jina_ac571567fe794919b8909e9fd39c226e168_SzNyRHyXaimyM7eJp_UuQaQ3os"
VERBOSE = int(os.getenv("VERBOSE", 1)) == 1


def save_lang_graph(graph, full_file_path):
    img_bytes = graph.draw_mermaid_png(draw_method=MermaidDrawMethod.API)
...
- Maintain objectivity in all assessments and recommendations"""
    ...
    if not dry_run:
        ...
        save_lang_graph(
            ...
            "lc_BI_supervisor(plan_research_supervisor).png",
        )